...
const translations: Dictionary = {
  ...
  'zh-CN': {
    ...
    login: {
      ...
      registerSuccess: '账号已创建，现在可以登录。',
      noAccountPrompt: '还没有账号？',
      haveAccountPrompt: '已经有账号了？',
  ...
  'es-ES': {
    ...
    login: {
      ...
      registerSuccess: 'La cuenta se ha creado. Ya puedes iniciar sesión.',
      noAccountPrompt: '¿Necesitas una cuenta?',
      haveAccountPrompt: '¿Ya tienes una cuenta?',
      switchToRegister: 'Crear una',
      switchToLogin: 'Volver a iniciar sesión',
      sso: 'Acceder con SSO',
